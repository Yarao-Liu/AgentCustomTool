...
class MindmapService:
    ...
    async def process_markdown_replace(request: Request, content: str):
        ...
        try:
            ...
            # 替换CDN链接为本地路径
            html_content = html_content.replace('https://cdn.jsdelivr.net/npm/d3@7.9.0/dist', '../../js')
            html_content = html_content.replace('https://cdn.jsdelivr.net/npm/markmap-toolbar@0.18.10/dist', '../../js')
            html_content = html_content.replace('https://cdn.jsdelivr.net/npm/markmap-view@0.18.10/dist', '../../js')
            html_content = html_content.replace('https://cdn.jsdelivr.net/npm/markmap-toolbar@0.18.10/dist', '../../js')
            # 写回文件
